...
module.exports = {
  mode: 'development',
  entry: {
    main: path.resolve(ROOT_DIRECTORY, 'src/index.js'), //fuck this webpacktemplate. this tells it "this is the entry point"
    //test: path.resolve(ROOT_DIRECTORY, 'src/index.js'), //https://www.ivarprudnikov.com/static-website-multiple-html-pages-using-webpack-plus-github-example/
  },
  output: {
